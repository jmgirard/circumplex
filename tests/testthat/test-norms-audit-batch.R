...
test_that("a missing divisor column is refused (M80)", {
  ...
  expect_abort_at_site(
    function() env$validate_batch(b), "stopifnot",
...
test_that("a non-numeric divisor is refused (M80)", {
  ...
  expect_abort_at_site(
    function() env$validate_batch(with_divisor(c("1", "8"))),
...
test_that("an NA divisor is refused, and named (M80)", {
  env <- batch_defs()
  expect_abort_at_site(
    function() env$validate_batch(with_divisor(c(1, NA_real_))),
...
test_that("a non-finite divisor is refused (M80)", {
  ...
  expect_abort_at_site(
    function() env$validate_batch(with_divisor(c(1, Inf))),
...
test_that("a zero or negative divisor is refused (M80)", {
  ...
  expect_abort_at_site(
    function() env$validate_batch(with_divisor(c(1, 0))),
