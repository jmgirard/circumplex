...
- 2026-08-09: T18 verified, status to review. `devtools::check(args = "--no-manual")` Status OK -- 0 errors, 0 warnings, 0 notes, 23m04s -- `pkgdown::check_pkgdown()` no problems, `cairn_validate` exit 0 with 48 pre-existing M7 advisories.
