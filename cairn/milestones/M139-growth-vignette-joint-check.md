...
- 2026-09-17: T4 done. The recipe guard is `stopifnot(all(V_xy != 0))` over the 2x2 intercept/slope cross block, printed above it; `Rscript devel/m27-growth-recipe.R` exits 0.
