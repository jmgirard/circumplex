...
- [ ] **T1** — NEWS.md dependency bullet (`NEWS.md:249-251`) and cran-comments.md (the `Notes on dependencies` paragraph at `:87-88`, the summary-of-changes bullets at `:56` and the highlights list) corrected per AC1/AC2, each figure derived by the command the criterion names.
