...
_Last hygiene check: 2026-07-12 (candidate audit; pre-release oracle re-reads → M7 AC3/T3; contrast-cert consistency → M15)_
...
| M15 | Contrast certification-conditional reporting consistency (ci_accuracy ↔ print) | blocked | — | normal | milestones/M15-contrast-cert-consistency.md |
