...
| iip32 | verified: M, SD, Size, item map, Reference (3 samples); the `Population` strings were rewritten here to describe the manual's national standardization sample (no angles, no URL published) | M75 | [horowitz2003.md](horowitz2003.md) | 2026-08-07 |
| iip64 | verified: M, SD, Size, item map, Reference (3 samples); the `Population` strings were rewritten here to describe the manual's national standardization sample (no angles, no URL published) | M75 | [horowitz2003.md](horowitz2003.md) | 2026-08-07 |
