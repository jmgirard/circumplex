...
Chapter-twin re-check: the .05 / .08 / .10 cutoffs and the m = 2 worked-example table row (4.915, 0.098, (0.083; 0.113), 7.282, (6.612; 8.086), 417.81) were re-verified 2026-07-21 by M48 against `sources/browne1993.pdf` chapter p. 144 (PDF p. 9) by the same two machine channels — `pdftotext -layout` and a read of the `pdftoppm`-rendered page image — matching the 1992 values banked here word-for-word and digit-for-digit; still no page read by a human — observed 2026-07-21.
