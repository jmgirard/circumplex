...
* Every vignette now opens with a Level line (Introductory, Intermediate or
  ...
  Wrap-up that names the next page to read. The website groups the vignettes
  by level in reading order, and the "Axes Reliability" vignette now appears
  in its Vignettes menu.
