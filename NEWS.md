...
* `?axes_reliability` no longer says that the same ill-conditioned fit can
  ...
  matrix. Its worst estimate differed between macOS with R's reference BLAS and
  LAPACK and Linux with OpenBLAS, and both machines refused it as `"uncertified"`.
