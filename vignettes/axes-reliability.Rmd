...
**The global fit statistics are approximate; the standard errors are not.**
...
The **fit indices are not corrected** and still want reading as a rough guide
rather than an exact test: they carry the same mismatch in the other direction
and are flattered by roughly 4%.
