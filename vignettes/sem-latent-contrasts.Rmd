...
that the gate lets through. Section 4, "When to trust it: limitations", lists the
assumptions that the latent layer rests on. Section 5, "Relation to the
literature", places the method beside the published circumplex models. The
