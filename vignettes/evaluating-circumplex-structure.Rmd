...
analytic intervals only (and not every marker was measured, as the next
passage details), so they are not validated as predictors of the bootstrap
intervals they accompany. When the intervals are analytic the list instead
