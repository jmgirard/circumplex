...
# This vignette uses lavaan, which circumplex only Suggests. Every code chunk
# is gated on lavaan being installed so the vignette still builds without it.
