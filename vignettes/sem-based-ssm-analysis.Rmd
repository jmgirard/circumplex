...
gate for interpreting displacement: when the amplitude confidence interval
includes (or nearly reaches) zero, the profile has no well-defined direction
and the displacement is not interpretable — the low-fit dashing on plots and the
displacement caution in `print()` behave exactly as they do for observed
profiles.
