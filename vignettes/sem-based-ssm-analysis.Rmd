...
whose CFI is the plain normal-theory one, which means `estimator = "ML"`.
Because the default estimator is `"MLR"`, the ladder above prints its `dcfi`
value marked as outside that validated scope, with no verdict attached. That is
a deliberate refusal rather than a gap: extending the cutoff to a robust index
or to three or more groups would take simulation work nobody has done.
