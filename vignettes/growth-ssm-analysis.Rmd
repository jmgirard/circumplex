...
the wide table as its own profile through `ssm_parameters_id()`. Then it
...
`value` is `NA`. glmmTMB drops such a row by default. Its fixed effects and their covariance go to
