...
200 persons per cell. The $d(t)$ intervals held coverage between .93 and
...
`devel/m27-coverage-oracle.md` in the package source.
...
to simulation error. The helper takes only a covariance matrix, so no $t$
