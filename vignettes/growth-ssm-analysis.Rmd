...
This is a realistic situation, because a person's shift rarely lies along
the $x$ or $y$ axis alone. In that design, the shortcut's pointwise $d(t)$
...
`NA` makes it impossible to place every later wave on a branch, so `NA`
