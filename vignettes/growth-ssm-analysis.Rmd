...
wrap correctly rather than spanning "the long way around." For plotting or
reading the trend, unwrap the estimated trajectory onto a continuous
branch with `angle_unwrap()`:

```{r plot, eval = has_glmmTMB, fig.width = 5, fig.height = 3.5}
...
(Each interval endpoint is placed on the same branch as its estimate by its
signed circular distance from it; near the boundary the endpoints may
legitimately fall outside $[0°, 360°)$.)
