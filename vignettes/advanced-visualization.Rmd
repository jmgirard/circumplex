...
The difference between those two figures is exactly what `ggcircumplex()` adds
on top of the coordinate system: the spoke breaks, their scale labels, and the
theme. Build from the parts when you want to vary one of them; reach for
`ggcircumplex()` when you do not.
