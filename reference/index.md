...
- [`score()`](http://circumplex.jmgirard.com/reference/score.md) : Score
  circumplex scales from item responses
...
Helpers for a growth model on SSM coordinates fit by a mixed-model
engine
...
- [`ssm_growth_formula()`](http://circumplex.jmgirard.com/reference/ssm_growth_formula.md)
  [`print(`*`<circumplex_growth_formula>`*`)`](http://circumplex.jmgirard.com/reference/ssm_growth_formula.md)
...
- [`ssm_trajectory()`](http://circumplex.jmgirard.com/reference/ssm_trajectory.md)
  [`print(`*`<circumplex_ssm_trajectory>`*`)`](http://circumplex.jmgirard.com/reference/ssm_trajectory.md)
  [`rbind(`*`<circumplex_ssm_trajectory>`*`)`](http://circumplex.jmgirard.com/reference/ssm_trajectory.md)
...
- [`print(`*`<circumplex_cpm>`*`)`](http://circumplex.jmgirard.com/reference/print.circumplex_cpm.md)
...
- [`plot(`*`<circumplex_cpm>`*`)`](http://circumplex.jmgirard.com/reference/plot.circumplex_cpm.md)
...
- [`print(`*`<circumplex_structure>`*`)`](http://circumplex.jmgirard.com/reference/print.circumplex_structure.md)
  : Print circumplex-structure test results
- [`summary(`*`<circumplex_structure>`*`)`](http://circumplex.jmgirard.com/reference/summary.circumplex_structure.md)
  : Summarize circumplex-structure test results
- [`plot(`*`<circumplex_structure>`*`)`](http://circumplex.jmgirard.com/reference/plot.circumplex_structure.md)
...
- [`axes_reliability()`](http://circumplex.jmgirard.com/reference/axes_reliability.md)
  ...
  Holtforth, 2013)
- [`print(`*`<circumplex_axes_reliability>`*`)`](http://circumplex.jmgirard.com/reference/print.circumplex_axes_reliability.md)
  : Print circumplex axes-reliability results
- [`summary(`*`<circumplex_axes_reliability>`*`)`](http://circumplex.jmgirard.com/reference/summary.circumplex_axes_reliability.md)
...
- [`geom_ssm_ellipse()`](http://circumplex.jmgirard.com/reference/geom_ssm_ellipse.md)
  : Draw a joint confidence ellipse for SSM coordinates in circumplex
  space
- [`ssm_ellipse_data()`](http://circumplex.jmgirard.com/reference/ssm_ellipse_data.md)
  : Centre and covariance of the Cartesian SSM coordinates for an
  ellipse layer
...
- [`poles()`](http://circumplex.jmgirard.com/reference/poles.md) :
...
- [`PANO()`](http://circumplex.jmgirard.com/reference/PANO.md) :
  Two-letter abbreviations for octant circumplex scales

## Example Data

- [`aw2009`](http://circumplex.jmgirard.com/reference/aw2009.md) :
  Standardized octant scores on hypothetical circumplex scales
- [`jz2017`](http://circumplex.jmgirard.com/reference/jz2017.md) : Raw
  octant scores on real circumplex scales with covariates
- [`raw_iipsc`](http://circumplex.jmgirard.com/reference/raw_iipsc.md) :
