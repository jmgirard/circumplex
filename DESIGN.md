...
|----|----|
| LM at 360°, not 0° | Matches published SSM tradition (Wright et al. 2009 tables); keeps [`octants()`](http://circumplex.jmgirard.com/reference/octants.md) monotone-free but consistent with norms tables, which store 360. Mixing 0 and 360 breaks [`norm_standardize()`](http://circumplex.jmgirard.com/reference/norm_standardize.md) matching. |
